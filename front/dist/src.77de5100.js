...
},{"socket.io-parser":"../node_modules/socket.io-parser/dist/index.js","component-emitter":"../node_modules/component-emitter/index.js","./on":"../node_modules/socket.io-client/build/on.js","debug":"../node_modules/debug/src/browser.js"}],"../node_modules/backo2/index.js":[function(require,module,exports) {
...
},{"engine.io-client":"../node_modules/engine.io-client/lib/index.js","./socket":"../node_modules/socket.io-client/build/socket.js","component-emitter":"../node_modules/component-emitter/index.js","socket.io-parser":"../node_modules/socket.io-parser/dist/index.js","./on":"../node_modules/socket.io-client/build/on.js","backo2":"../node_modules/backo2/index.js","debug":"../node_modules/debug/src/browser.js"}],"../node_modules/socket.io-client/build/index.js":[function(require,module,exports) {
"use strict";
...
},{"./url":"../node_modules/socket.io-client/build/url.js","./manager":"../node_modules/socket.io-client/build/manager.js","./socket":"../node_modules/socket.io-client/build/socket.js","debug":"../node_modules/debug/src/browser.js","socket.io-parser":"../node_modules/socket.io-parser/dist/index.js"}],"img/helicol.png":[function(require,module,exports) {
module.exports = "/helicol.3f4ebd73.png";
},{}],"img/bullet.png":[function(require,module,exports) {
module.exports = "/bullet.744eddd5.png";
},{}],"scripts/Bullet.ts":[function(require,module,exports) {
"use strict";
...
var bullet_png_1 = __importDefault(require("../img/bullet.png"));

var Bullet =
/** @class */
function () {
  function Bullet(x, y, direction, parent) {
    var _this = this;
    ...
    this.element.setAttribute('src', bullet_png_1.default);
...
},{"../img/bullet.png":"img/bullet.png"}],"scripts/Ship.ts":[function(require,module,exports) {
"use strict";
...
var helicol_png_1 = __importDefault(require("../img/helicol.png"));
...
/** @class */
function () {
  function Ship(x, y, isFlipped, parent) {
    if (x === void 0) {
      x = 0;
    }
    ...
    this.bullet = null;
    this.element = document.createElement('img');
    this.element.setAttribute('src', helicol_png_1.default);
  ...
  Ship.prototype.updatePosition = function (x, y) {
    if (x === void 0) {
      x = 0;
    }
  ...
  Ship.prototype.setPosition = function (x, y, isFlipped) {
    if (x === void 0) {
      x = 0;
    }
  ...
  Ship.prototype.setFlipped = function (isFlipped) {
    this.isFlipped = isFlipped;
  };
  ...
  Ship.prototype.shoot = function () {
    ...
    var variation = 0;
    if (this.isFlipped) variation = 100;else variation = -50;
    this.bullet = new Bullet_1.default(this.x + variation, this.y, this.isFlipped);
  };

  Ship.prototype.broadcastPosition = function (socket, isShooting) {
...
},{"../img/helicol.png":"img/helicol.png","./Bullet":"scripts/Bullet.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var Ship_1 = __importDefault(require("./scripts/Ship"));
...
socket.on('playerNumber', function (number) {
  if (number === 1) {
    myNumber = 1;
    playerOne = new Ship_1.default(0, 0, true);
  } else if (number === 2) {
    myNumber = 2;
    playerOne = new Ship_1.default(700);
    playerTwo = new Ship_1.default(0, 0, true);
  } else {
    playerOne = new Ship_1.default(700);
    playerTwo = new Ship_1.default(0, 0, true);
    return;
...
socket.on('playerJoin', function (number) {
  if (number === 2) {
    playerTwo = new Ship_1.default(700);
  }
});
